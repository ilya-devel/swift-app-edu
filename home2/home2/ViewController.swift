...
class ViewController: UIViewController {
    ...
    @objc private func tap() {
        ...
        let tmp = UINavigationController(rootViewController: CollectionViewController())
        
        friend.tabBarItem.title = "Friends"
        group.tabBarItem.title = "Groups"
        photo.tabBarItem.title = "Photos"
        
        tmp.tabBarItem.title = "Tmp"
        
        let controllers = [friend, group, photo, tmp]
